...
public class DmValueService {
    ...
    public Optional<DmValue> getCurrentByAddress(DeviceInfo device, int address) {
        return repository.findCurrentByAddress(device.getMnemonic(), address);
    }
    ...
    public Optional<DmValue> getLatest(DeviceInfo device) {
        return repository.findLatest(device.getMnemonic());
    }
