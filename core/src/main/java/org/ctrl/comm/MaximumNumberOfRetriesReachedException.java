...
public class MaximumNumberOfRetriesReachedException extends ComException {
     ...
     * @param message
     */
    public MaximumNumberOfRetriesReachedException(String message, IMessage comMessage) {
        super(message);
     ...
     */
    public void setComMessage(IMessage comMessage) {
