...
final public class Modbus {
    ...
    static public boolean checkServerAddress(int serverAddress) {
         ...
         * some of modbus tcp slaves sets the UnitId value to zero, not ignoring value
         * in this field.
         */
     ...
     * @param max   - maximum
     * @return "true" if offset in the range from Modbus.MIN_START_ADDRESS to max,
     *         else "false".
     */
     ...
     *
     * @return "true" if autoincrement of TransactionId field is enabled, else
     *         "false".
     */
    ...
    /**
     * activates auto increment of TransactionId field. if you do not use ModbusTCP,
     * invocation has no effect.
     *
     * @param autoIncrementTransactionId - new value of the
     *                                   autoIncrementTransactionId variable
     */
