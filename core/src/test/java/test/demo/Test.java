	...
	public static void initSystem() {
		...
		try {
			...
			if (comHandler.isStarted()) {
				...
				//
				// System.out.println("Test - RESPOSTA DO CLP "+
				// readData.getResponseStatusCode());
				//
				//
				...
				//
				// System.out.println("Test - valor recebido em string >>>>>>" +
				// readData.getReply().toString());
				//
				// String strBinario = utils.getFormatedBinary(i);
				//
				//
				// System.out.println("Test - Valor em binário convertido com OmronUtils " +
				// strBinario);
				//
				// String recebido = readData.getReply().toString();
				//
				// System.out.println("Test - Valor em binário atraves de uma string " +
				// utils.getFormatedBinary(recebido));
				//
				...
				// }
				//
				// System.out.println("\nTest - Tamanho da string " +
				// utils.getFormatedBinary(i).length() );
				//
				...
				// System.out.println("Teste bits canal HR 0 >>>>>> " +
				// utils.getFormatedBinary(diCIO.toString()));
				...
				// VERIFICAR O ERRO QUE ESTÁ OCORRENDO NO ENVIO DA MENSAGEM, ESTÁ ENVIANDO VALOR
				// INCORRETO.
				...
				// System.out.println("Valor rebido do HR" + endereco + " : "+
				// utils.convertHexDec(readHR.getReply().toString()));
