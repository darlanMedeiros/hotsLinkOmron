		...
		try {
			...
			if (portIdentifier.isCurrentlyOwned()) {
				...
				if (commPort instanceof purejavacomm.SerialPort) {
					...
					port.setSerialPortParams(sp.getBaudRate(), sp.getDataBits(), sp.getStopBits(),
							sp.getParity().getValue());
			...
			throw new SerialPortException("Serial port does not exist ", e);
		} catch (PortInUseException e) {
			throw new SerialPortException("Serial port in use ", e);
		}
