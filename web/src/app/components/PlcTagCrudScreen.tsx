                ...
                <tbody>
                  {tags.map((row) => {
                    ...
                    return (
                      <tr key={row.id} className="border-t border-slate-100">
                        <td className="py-2 pr-2">{row.id}</td>
                        <td className="py-2 pr-2">{editing ? <input value={editingTag.name} onChange={(e) => setEditingTag({ ...editingTag, name: e.target.value })} className="w-36 rounded border border-slate-300 px-2 py-1" /> : row.name}</td>
                        <td className="py-2 pr-2">
                          {editing ? (
